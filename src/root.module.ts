...
import { PlatformLocation, registerLocaleData, LocationStrategy, HashLocationStrategy, PathLocationStrategy } from '@angular/common';
        ...
        return new Promise<boolean>((resolve, reject) => {
            ...
            AppPreBootstrap.run(appBaseUrl, () => {
                ...
                localForage.config({
                    ...
                    description: 'Cached data for Demo'
                });
